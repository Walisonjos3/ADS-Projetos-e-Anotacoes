public class Produto {
    ...
    public void aplicarDesconto(double desconto) {
        if (this.preco <= 0){
            ...
            System.out.printf("\nR$ %.2f de desconto aplicado!", desconto);
        }
    }

    public void retirarEstoque(int quantidade) {
        if (quantidade > this.getQuantidade()){
            System.out.println("\nImpossível diminuir o estoque.");
        } else {
    ...
    public void temEstoque(int quantidade) {
        if (quantidade > this.getQuantidade()) {
            System.out.println("\nNão tem essa quantidade no estoque.");
        } else {
    ...
    public void mostrarDados() {
        ...
        System.out.printf("Quantidade em estoque: %d unidades%n", this.getQuantidade());
    }
